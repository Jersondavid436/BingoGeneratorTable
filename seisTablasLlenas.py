...
#crea el documento
pdf_file = "reporte_tablas_de_seis_llenas.pdf"
...
def creacion_tablas(num):
    for i in range(num):
        tbl6.tabla_principal()
        tb1= tabla_resultado(tbl6)
        tb2=tabla_resultado(tbl6)
        tb3=tabla_resultado(tbl6)
        tb4=tabla_resultado(tbl6)
        tb5=tabla_resultado(tbl6)
        tb6=tabla_resultado(tbl6)
        ...
        data1 = asignar_tabla(tb1)
        data2 = asignar_tabla(tb2)
        data3 = asignar_tabla(tb3)
        data4 = asignar_tabla(tb4)
        data5 = asignar_tabla(tb5)
        data6 = asignar_tabla(tb6)
